...
#else
	ConVar	sv_accelerate	( "sv_accelerate", "9999999999", FCVAR_NOTIFY | FCVAR_REPLICATED);
#endif // CSTRIKE_DLL
...
#else
ConVar	sv_airaccelerate(  "sv_airaccelerate", "9999999999", FCVAR_NOTIFY | FCVAR_REPLICATED );    
ConVar	sv_wateraccelerate(  "sv_wateraccelerate", "9999999999", FCVAR_NOTIFY | FCVAR_REPLICATED );     
ConVar	sv_waterfriction(  "sv_waterfriction", "1", FCVAR_NOTIFY | FCVAR_REPLICATED );      
ConVar	sv_footsteps	( "sv_footsteps", "1", FCVAR_NOTIFY | FCVAR_REPLICATED, "Play footstep sound for players" );
ConVar	sv_rollspeed	( "sv_rollspeed", "200", FCVAR_NOTIFY | FCVAR_REPLICATED);
ConVar	sv_rollangle	( "sv_rollangle", "1.50", FCVAR_NOTIFY | FCVAR_REPLICATED, "Max view roll angle");
#endif // CSTRIKE_DLL
