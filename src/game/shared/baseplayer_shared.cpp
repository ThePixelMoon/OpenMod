...
void CBasePlayer::ItemPostFrame()
{
	...
	if (GetActiveWeapon())
	{
		ConVarRef v_viewmodel_fov("viewmodel_fov");
		char szWeap[64];
		...
		if (FStrEq("weapon_rpg_hl1", szWeap) || FStrEq("weapon_satchel_hl1", szWeap) || FStrEq("weapon_shotgun_hl1", szWeap) ||
			...
			FStrEq("weapon_gauss_hl1", szWeap) || FStrEq("weapon_glock_hl1", szWeap) ||
			FStrEq("weapon_hornetgun_hl1", szWeap) || FStrEq("weapon_mp5_hl1", szWeap) || FStrEq("weapon_crowbar_hl1", szWeap) ||
			FStrEq("weapon_handgrenade_hl1", szWeap) || FStrEq("weapon_tripmine", szWeap) || FStrEq("weapon_snark", szWeap))
		{
